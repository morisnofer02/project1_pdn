  ...
  <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    <div class="flex justify-between">
      <div class="text-3xl">Data Phone</div>
        <div>
    <a href="{{ route('tambah.phone') }}" class="bg-blue-500 hover:bg-blue-300 text-white p-2 border rounded-md"> Tambah Data</a>
  </div>
</div>
...
<table class="table w-full mt-5 border p-3">
  <thead>
    <tr class="border p-3">
      ...
      <th class="border p-3">Chipset</th>
      <th class="border p-3">Battery</th>
